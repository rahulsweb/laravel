...
class AddMoneyController extends Controller
{
    ...
    public function postPaymentWithpaypal(Request $request)
    {
        ...
        if(!$address)
        {
         ...
         $bill_address=$address->create($billing_address);
        ...
        if(!$address2)
        {
         ...
         $ship_address=$address2->create($shipping_address);
        ...
        if(isset($request->coupon))
        {
            ...
            'user_id'=>auth()->user()->id,
            'billing_id'=>isset($bill_address->id) ? $bill_address->id: $request->bill,
            'shipping_id'=>isset($ship_address->id) ? $ship_address->id: $request->ship,
