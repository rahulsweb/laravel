		...
		<div class="container">
			...
			<div class="form-group">
						<div class="order-message">
							...
							<ul class="list-group" id="address" style="display:none;">
					...
					<div class=" row ">
							<h3 class="text-info"><b>Billing Order</b></h3>
					...
					<div class=" row ">
						...
						<select id="ship" name="ship"  style=" padding:10px;">
    ...
    $(document).on('click', '#shipping', function() {      
	 ...
	 $("#address").hide();
			...
			$.ajax({
			   ...
			   $('select[name="ship"]').val(id).attr("selected",true);
			  
			   $('select[name="bill"]').val(id).attr("selected",true);
