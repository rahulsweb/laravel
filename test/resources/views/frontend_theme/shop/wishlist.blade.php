        ...
        <div class="table-responsive cart_info">
            ...
            <table class="table table-condensed">
                ...
                <tbody>
                    ...
                    <?php $count_wishlist=count(auth()->user()->wishlists); ?>
                    @else
                    <?php $count_wishlist=count(auth()->user()->wishlists); ?>
                    @endif
                    ...
                    <tr>
                       ...
                       <td><strong>{{ $product->name }}</strong></td>
                        ...
                        <td> <img src="{{ asset($product_image->where('product_id',$product->id)->first()->name) }}" width=100 height=100 ></td>      
                        <td>    
                            ...
                            @endif
                                ...
                                @if($check))
                                <a href=""  onclick="return false" class="btn btn-default add-to-cart "><i class="fa fa-plus-square"></i>Already In  Cart</a>
                                @else    
