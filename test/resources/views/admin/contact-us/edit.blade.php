...
0574ed14a93b1787098284f56ef7ae65-us20
  <!-- Main content -->
        ...
        <div class="container">
                <div class="row">
                    ...
                    <div class="col-md-9">
                        ...
                        <form method="POST" action="{{ url('/admin/contact-us/' . $contactus->id) }}" accept-charset="UTF-8" class="form-horizontal" enctype="multipart/form-data">
                            {{ method_field('PATCH') }}
                            {{ csrf_field() }}
