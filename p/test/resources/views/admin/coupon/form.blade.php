...
<div class="form-group {{ $errors->has('qty') ? 'has-error' : ''}}">
        ...
        <input class="form-control" name="qty" type="number" id="qty" min="1" max="50" value="{{ isset($coupon->qty) ? $coupon->qty : ''}}" >
        {!! $errors->first('qty', '<p class="help-block">:message</p>') !!}
    </div>

<div class="form-group {{ $errors->has('discount') ? 'has-error' : ''}}">
        <label for="discount" class="control-label">{{ 'discount' }}</label>
        <input class="form-control" name="discount" type="number" id="discount" min="5" max="50" value="{{ isset($coupon->discount) ? $coupon->discount : ''}}" >
