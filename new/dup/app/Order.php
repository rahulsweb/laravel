...
class Order extends Model
{
    ...
    //relation of shipping  addresses  to Order related user
    public function shipping_address()
    {
        return $this->belongsTo(Address::class, 'shipping_id');
    }
     //relation of billing  addresses  to Order related user
    public function billing_address()
    {
        return $this->belongsTo(Address::class, 'billing_id');
    }
 //relation of coupon  to Order related user
    public function coupons()
    {
        return $this->belongsTo(Coupon::class, 'coupon_id');
    }

    //scope getOrder get detail of related to user
    ...
    public function scopeGetOrder($query)
    {
        ...
        //scope scopeSearch get detail of related to user when input search value
    ...
    public function scopeSearch($query, $keyword)
    {
     ...
     //scope scopeSearchEmail get detail of related to user when input search email
    ...
    public function scopeOrderById($query)
    {
        ...
        return $query->WhereNotNull('coupon_id')->with('coupons', 'users')->orderBy('id', 'DESC');
         ...
         //scope scopeSearchByCoupon get detail of related to user when input search value coupons
    public function scopeSearchByCoupons($query, $keyword)
    {
     ...
     //scope scopeOrderSearch get detail of related to user when input search value Order Search
    public function OrderSearch($query,$search)
    {
     ...
     //scope OrderWithoutSearch get detail of related to user 
    public function OrderWithoutSearch($query)
    {
        return $query->join('coupons', 'orders.coupon_id', '=', 'coupons.id')
                ->join('users', 'orders.user_id', '=', 'users.id')
     ...
     //scope SearchOrderCode get detail of related to user when user Search Order Code
public function SearchOrderCode($query,$search)
    {
