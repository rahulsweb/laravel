...
class AddMoneyController extends Controller
{
    ...
    public function postPaymentWithpaypal(Request $request)
    {
        ...
        try {
            ...
            $this->addressStore($request);
            $this->orderPlace($request);
    ...
    //cash on delivery order place method
    ...
    //address Storing in a database after placing order
    public function addressStore(Request $request)
    {
        ...
        $address2 = Address::where('address1', '=', $request->ship_address1)->where('address2', '=', 
            $request->ship_address2)->where('fullname', '=', $request->fullname)->first();
      
//storing billing address in database if not exist
        ...
        //storing shipping address in database if not exist
    ...
    //order place detail in store database
