  ...
  <section class="content ">
   ...
   <div class="box">
            ...
            <div class="box-body">
                                ...
                                <a href="{{ url('/admin/email-template/create') }}" class="btn btn-success btn-md" title="Add New email">
                                             ...
                                             <td>                                            
                                               ...
                                               @role('admin')
                                                <td>
                                                    ...
                                                    <a href="{{ url('/admin/email-template/' . $item->id) }}" title="View email"><button class="btn btn-info btn-sm"><i class="fa fa-eye" aria-hidden="true"></i> View</button></a>
                                                    <a href="{{ url('/admin/email-template/' . $item->id . '/edit') }}" title="Edit email"><button class="btn btn-primary btn-sm"><i class="fa fa-pencil-square-o" aria-hidden="true"></i> Edit</button></a>
                                                             @can('user-edit')
