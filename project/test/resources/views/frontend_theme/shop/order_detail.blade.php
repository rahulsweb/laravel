...
<section class="products" >
     ...
     @foreach ($product->order_carts as $data )
<?php $total+=$data->pivot->total; ?>

@endforeach
     <h5>Total Qty:<b class=" text-info pull-right">{{ $product->order_carts->count('*') }}</b></h5>
<h5>Total:<b class="text-danger  pull-right" >{{ "Rs ".$total }}</b></h5>
