  ...
  <section class="content ">
   ...
   <div class="box">
            ...
            <div class="box-body">
                                ...
                                <a href="<?php echo e(url('/admin/cms/create')); ?>" class="btn btn-success btn-md" title="Add New email">
                                             ...
                                             <td>                                            
                                               ...
                                               <?php if (Auth::check() && Auth::user()->hasRole('admin')): ?>
                                                <td>
                                                    ...
                                                    <a href="<?php echo e(url('/admin/cms/' . $item->id)); ?>" title="View email"><button class="btn btn-info btn-sm"><i class="fa fa-eye" aria-hidden="true"></i> View</button></a>
                                                    <a href="<?php echo e(url('/admin/cms/' . $item->id . '/edit')); ?>" title="Edit email"><button class="btn btn-primary btn-sm"><i class="fa fa-pencil-square-o" aria-hidden="true"></i> Edit</button></a>
                                                             <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('user-edit')): ?>
                                                    <form method="POST" action="<?php echo e(url('/admin/cms' . '/' . $item->id)); ?>" accept-charset="UTF-8" style="display:inline">
